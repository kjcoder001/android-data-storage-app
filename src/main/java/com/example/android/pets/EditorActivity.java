...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertDb()
    {
        ...
        /*
        The following code attempts to access the database directly which is a bad practise.
        Replaced with a resolver and provider code!!
         */
        ...
        if(x!=-1)
            Toast.makeText(this, "Pet entered with coulumn number "+x, Toast.LENGTH_SHORT).show();
        else
            Toast.makeText(this, "Error inserting the pet", Toast.LENGTH_SHORT).show();
         */
